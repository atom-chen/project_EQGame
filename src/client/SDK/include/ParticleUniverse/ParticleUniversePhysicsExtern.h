	...
	*/
	class _ParticleUniverseExport PhysicsExtern : public Extern
	{
		...
		*/
		...
		/** Create an actor.
		*/
		virtual PhysicsActor* createPhysicsActor(PhysicsActorDesc* physicsActorDesc, PhysicsShapeDesc* physicsShapeDesc) = 0;

		/** Destroy an actor.
		*/
		virtual void destroyPhysicsActor(PhysicsActor* physicsActor) = 0;
	};
