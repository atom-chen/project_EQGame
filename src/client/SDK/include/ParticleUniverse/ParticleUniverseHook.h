    ...
    */
	...
	class _ParticleUniverseExport Hook
	{
		public:
			...
			*/
			static inline void _prepare(std::vector<T*>* list, ParticleTechnique* technique)
			{
				if (list->empty())
					return;
			...
			*/
			static inline void _unprepare(std::vector<T*>* list, ParticleTechnique* technique)
			{
				if (list->empty())
					return;
			...
			*/
			static inline void _notifyStart(std::vector<T*>* list)
			{
				if (list->empty())
					return;
			...
			*/
			static inline void _notifyPause(std::vector<T*>* list)
			{
				if (list->empty())
					return;
			...
			*/
			static inline void _notifyResume(std::vector<T*>* list)
			{
				if (list->empty())
					return;
			...
			*/
			static inline void _notifyStop(std::vector<T*>* list)
			{
				if (list->empty())
					return;
			...
			*/
			static inline void _preProcessParticles(std::vector<T*>* list, ParticleTechnique* technique, Ogre::Real timeElapsed)
			{
				if (list->empty())
					return;
			...
			*/
			static inline void _processParticle(std::vector<T*>* list, 
			...
			*/
			static inline void _postProcessParticles(std::vector<T*>* list, ParticleTechnique* technique, Ogre::Real timeElapsed)
			{
				if (list->empty())
					return;
