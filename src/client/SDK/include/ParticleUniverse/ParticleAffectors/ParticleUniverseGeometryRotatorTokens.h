...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport GeometryRotatorTokens : public ParticleAffectorTokens
	{
		public:
			// Constants
		...
		protected:
			...
			*/
			...
			class RotationAxis : public IToken {virtual void parse(ParticleScriptDeserializer* deserializer);} mRotationAxis;
	};
