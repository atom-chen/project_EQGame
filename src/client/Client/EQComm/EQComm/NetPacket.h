...
struct player_task_action : public INetPacket
{
	int type;
	int finish_amount;
	void encode(ByteArray &byteArray)
	{
		byteArray.write_int(type);
		byteArray.write_int(finish_amount);
	}

	void decode(ByteArray &byteArray)
	{
		type = byteArray.read_int();
		finish_amount = byteArray.read_int();
	}

	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_player_task_action);
		encode(byteArray);
	}
};
...
struct player_task : public INetPacket
{
	...
	int status;
	stime create_date;
	std::vector<player_task_action> action_list;
	void encode(ByteArray &byteArray)
	{
		byteArray.write_uint64(id);
		byteArray.write_string(account);
		...
		byteArray.write_uint16(action_list.size());
		for(size_t i=0; i<action_list.size();i++)
		{
			action_list[i].encode(byteArray);
		}
	...
	void decode(ByteArray &byteArray)
	{
		...
		{
		UINT16 size = byteArray.read_uint16();
		action_list.resize(size);
		for(int i=0; i<size;i++)
		{
			action_list[i].decode(byteArray);
		}
		}
...
struct req_walk_for_body_action : public INetPacket
{
	point curr_pos;
	point dest_pos;
	std::string my_action;
	std::string you_action;
	std::string you_account;
	point you_pos;
	int move_type;
	void encode(ByteArray &byteArray)
	{
		...
		byteArray.write_string(my_action);
		byteArray.write_string(you_action);
		byteArray.write_string(you_account);
		you_pos.encode(byteArray);
	...
	void decode(ByteArray &byteArray)
	{
		...
		my_action = byteArray.read_string();
		you_action = byteArray.read_string();
		you_account = byteArray.read_string();
		you_pos.decode(byteArray);
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_req_walk_for_body_action);
		encode(byteArray);
	}
};
...
struct req_chat_big_expression : public INetPacket
{
	int exp_id;
	void encode(ByteArray &byteArray)
	{
		byteArray.write_int(exp_id);
	}

	void decode(ByteArray &byteArray)
	{
		exp_id = byteArray.read_int();
	}

	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_req_chat_big_expression);
		encode(byteArray);
	}
};

struct notify_chat_big_expression : public INetPacket
{
	std::string account;
	std::string player_name;
	int exp_id;
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_notify_chat_big_expression);
		encode(byteArray);
	}
};
...
struct notify_open_all_light : public INetPacket
{
	int turn_on;
	void encode(ByteArray &byteArray)
	{
		byteArray.write_int(turn_on);
	}

	void decode(ByteArray &byteArray)
	{
		turn_on = byteArray.read_int();
	}

	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_notify_open_all_light);
		encode(byteArray);
	}
};
...
struct notify_agree_invitation : public INetPacket
{
	std::string agreer;
	int type;
	void encode(ByteArray &byteArray)
	{
		byteArray.write_string(agreer);
		byteArray.write_int(type);
	}

	void decode(ByteArray &byteArray)
	{
		agreer = byteArray.read_string();
		type = byteArray.read_int();
	}

	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_notify_agree_invitation);
		encode(byteArray);
	}
};
...
struct notify_update_task_progress : public INetPacket
{
	uint64 id;
	int action_type;
	int action_amount;
	...
	{
		byteArray.write_uint64(id);
		byteArray.write_int(action_type);
		byteArray.write_int(action_amount);
	}

	void decode(ByteArray &byteArray)
	{
		id = byteArray.read_uint64();
		action_type = byteArray.read_int();
		action_amount = byteArray.read_int();
	}

	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_notify_update_task_progress);
		encode(byteArray);
	}
};
...
struct notify_buy_new_house_success : public INetPacket
{
	void encode(ByteArray &byteArray)
	{
	}
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_notify_buy_new_house_success);
		encode(byteArray);
	}
};
...
struct notify_today_flower_egg_count : public INetPacket
{
	std::string house_owner;
	int egg_count;
	int flower_count;
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_notify_today_flower_egg_count);
		encode(byteArray);
	}
};
...
struct req_common_scene_state : public INetPacket
{
	int teleport_id;
	void encode(ByteArray &byteArray)
	{
		byteArray.write_int(teleport_id);
	}

	void decode(ByteArray &byteArray)
	{
		teleport_id = byteArray.read_int();
	}

	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_req_common_scene_state);
		encode(byteArray);
	}
};

struct scene_state : public INetPacket
{
	int scene_id;
	int copy_id;
	int count;
	...
	void encode(ByteArray &byteArray)
	{
		...
		byteArray.write_int(copy_id);
		byteArray.write_int(count);
		byteArray.write_string(copy_name);
		byteArray.write_int(max_players);
		byteArray.write_int(busy_players);
		byteArray.write_int(loose_players);
		byteArray.write_int(status);
	}
	...
	void decode(ByteArray &byteArray)
	{
		...
		copy_id = byteArray.read_int();
		count = byteArray.read_int();
		copy_name = byteArray.read_string();
		max_players = byteArray.read_int();
		busy_players = byteArray.read_int();
		loose_players = byteArray.read_int();
		status = byteArray.read_int();
	}

	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_scene_state);
		encode(byteArray);
	}
};

struct notify_common_scene_state : public INetPacket
{
	std::vector<scene_state> scene_list;
	void encode(ByteArray &byteArray)
	{
		byteArray.write_uint16(scene_list.size());
		for(size_t i=0; i<scene_list.size();i++)
		{
			scene_list[i].encode(byteArray);
		}
	...
	void decode(ByteArray &byteArray)
	{
		{
		UINT16 size = byteArray.read_uint16();
		scene_list.resize(size);
		for(int i=0; i<size;i++)
		{
			scene_list[i].decode(byteArray);
		}
		}
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_notify_common_scene_state);
		encode(byteArray);
	}
};

struct req_cupid_participate : public INetPacket
{
	std::string account;
	int sex;
	...
	void encode(ByteArray &byteArray)
	{
		byteArray.write_string(account);
		byteArray.write_int(sex);
		byteArray.write_uint16(tags.size());
		for(size_t i=0; i<tags.size();i++)
		{
			byteArray.write_string(tags[i]);
		}
	...
	void decode(ByteArray &byteArray)
	{
		...
		for(int i=0; i<size;i++)
		{
			tags.push_back(byteArray.read_string());
		}
		}
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_req_cupid_participate);
		encode(byteArray);
	}
};

struct req_cupid_cancel_participate : public INetPacket
{
	std::string account;
	void encode(ByteArray &byteArray)
	{
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_req_cupid_cancel_participate);
		encode(byteArray);
	}
};

struct notify_cupid_participate : public INetPacket
{
	int result;
	void encode(ByteArray &byteArray)
	{
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_notify_cupid_participate);
		encode(byteArray);
	}
};

struct notify_cupid_cancel_participate : public INetPacket
{
	int result;
	void encode(ByteArray &byteArray)
	{
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_notify_cupid_cancel_participate);
		encode(byteArray);
	}
};

struct notify_cupid_girl_match_result : public INetPacket
{
	std::vector<std::string> tags;
	void encode(ByteArray &byteArray)
	{
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_notify_cupid_girl_match_result);
		encode(byteArray);
	}
};

struct notify_cupid_boy_match_result : public INetPacket
{
	std::vector<std::string> tags;
	int girl_result;
	void encode(ByteArray &byteArray)
	{
		...
		byteArray.write_int(girl_result);
	}
	...
	void decode(ByteArray &byteArray)
	{
		...
		girl_result = byteArray.read_int();
	}

	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_notify_cupid_boy_match_result);
		encode(byteArray);
	}
};

struct req_cupid_girl_confirm : public INetPacket
{
	std::string account;
	int result;
	void encode(ByteArray &byteArray)
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_req_cupid_girl_confirm);
		encode(byteArray);
	}
};

struct req_cupid_boy_confirm : public INetPacket
{
	std::string account;
	int result;
	int girl_result;
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_req_cupid_boy_confirm);
		encode(byteArray);
	}
};

struct req_create_party : public INetPacket
{
	int type;
	std::string title;
	...
	void encode(ByteArray &byteArray)
	{
		byteArray.write_int(type);
		byteArray.write_string(title);
		byteArray.write_string(description);
	}
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_req_create_party);
		encode(byteArray);
	}
};

struct notify_create_party_result : public INetPacket
{
	int result;
	void encode(ByteArray &byteArray)
	{
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_notify_create_party_result);
		encode(byteArray);
	}
};

struct req_edit_party : public INetPacket
{
	int type;
	std::string title;
	std::string description;
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_req_edit_party);
		encode(byteArray);
	}
};

struct notify_edit_party_result : public INetPacket
{
	int result;
	void encode(ByteArray &byteArray)
	{
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_notify_edit_party_result);
		encode(byteArray);
	}
};

struct req_delete_party : public INetPacket
{
	void encode(ByteArray &byteArray)
	{
	}
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_req_delete_party);
		encode(byteArray);
	}
};

struct req_get_party_list : public INetPacket
{
	void encode(ByteArray &byteArray)
	{
	}
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_req_get_party_list);
		encode(byteArray);
	}
};

struct party_data : public INetPacket
{
	...
	void encode(ByteArray &byteArray)
	{
		byteArray.write_string(create_account);
		byteArray.write_int(type);
		byteArray.write_string(title);
		byteArray.write_string(desc);
	}
	...
	void decode(ByteArray &byteArray)
	{
		create_account = byteArray.read_string();
		type = byteArray.read_int();
		title = byteArray.read_string();
		desc = byteArray.read_string();
	}
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_party_data);
		encode(byteArray);
	}
};

struct notify_party_list : public INetPacket
{
	std::vector<party_data> partys;
	void encode(ByteArray &byteArray)
	{
		byteArray.write_uint16(partys.size());
		for(size_t i=0; i<partys.size();i++)
		{
			partys[i].encode(byteArray);
		}
	...
	void build(ByteArray &byteArray)
	{
		byteArray.write_uint16(NetMsgType::msg_notify_party_list);
		encode(byteArray);
	}
};
