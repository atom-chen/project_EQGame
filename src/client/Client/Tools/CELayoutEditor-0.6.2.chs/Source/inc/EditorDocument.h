...
#include "..\vc++9\ActItemMove.h"
#include "..\vc++9\ActItemResize.h"
#include "..\vc++9\ActManager.h"
#include "..\vc++9\ActItemDel.h"
#include "..\vc++9\ActItemNew.h"
...
public:
    ...
    */
	...
	void PushActMoveUndoItem();
	void PushActResizeUndoItem();
	void PushActDelUndoItem();
	void PushActAddUndoItem(CEGUI::Window *parent, CEGUI::Window *window);
	//////////////////////////////////////////////////////////////////////////
...
private:
    ...
    * actions (true).*/
    ...
    //////////////////////////////////////////////////////////////////////////
	int m_xMDown, m_yMDown;
	ActManager m_actManager;
	//////////////////////////////////////////////////////////////////////////
