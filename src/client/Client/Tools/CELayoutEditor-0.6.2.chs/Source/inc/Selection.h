 ...
 * group. Selected windows get "boxed" in @link=CElementResizer}s, which provide a 
...
public:
    ...
    /** Selects the given element, when it is not selected yet.
    ...
    WindowBox* FindBoxFor(const CEGUI::Window* const aWindow);
    	...
    	//////////////////////////////////////////////////////////////////////////
	NRects &GetMoveableBoxNRects()
	{
		return m_moveableBoxNRects;
	}

	void SaveMoveableBoxNRects();
	//////////////////////////////////////////////////////////////////////////
