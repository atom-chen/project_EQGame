...
{
	wxString Name;//chs name
	wxString Desc;//chs desc
} PROPERTYITEMINFO, *LPPROPERTYITEMINFO;

typedef std::map<wxString, PROPERTYITEMINFO> PROPERTYDESCLIST;
...
public:
    ...
    */
    ...
    PROPERTYDESCLIST &GetProperDescList()
	{
		return m_pds;
	}
