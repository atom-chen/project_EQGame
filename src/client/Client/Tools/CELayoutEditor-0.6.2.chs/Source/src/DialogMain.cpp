...
#define MINIMUM_WIDTH 516
#define MINIMUM_HEIGHT 702
...
EVT_TREE_SEL_CHANGED  (ID_LAYOUT_TREE, DialogMain::OnSelchangedOverlayTree)
...
EVT_GRID_SELECT_CELL( DialogMain::OnSelectCell )
...
wxDialog(parent, wxID_ANY, wxT("属性设置对话框"), wxDefaultPosition, wxSize(MINIMUM_WIDTH, MINIMUM_HEIGHT), 
           (wxDEFAULT_DIALOG_STYLE & ~wxCLOSE_BOX) | wxRESIZE_BORDER | wxMINIMIZE_BOX) // Cannot be closed
{
...
#define ID_SPLITTERWINDOW 10015
#define ID_SPLITTERWINDOW1 10025
#define ID_PANEL 10016
#define ID_PANEL1 10017
#define ID_RADIOBUTTON 10020
#define ID_RADIOBUTTON1 10021

	DialogMain* itemDialog1 = this;

	wxBoxSizer* itemBoxSizer2 = new wxBoxSizer(wxVERTICAL);
	itemDialog1->SetSizer(itemBoxSizer2);

	wxSplitterWindow* splitter = new wxSplitterWindow( itemDialog1, ID_SPLITTERWINDOW, wxDefaultPosition, wxDefaultSize, wxSP_3DBORDER|wxSP_3DSASH|wxNO_BORDER );
	splitter->SetMinimumPaneSize(200);

	//------------------------------ Panel -------------------------------
	wxPanel* panel = new wxPanel( splitter, ID_PANEL, wxDefaultPosition, wxSize(200, -1), wxNO_BORDER|wxTAB_TRAVERSAL );
	wxStaticBox* itemStaticBoxSizer5Static = new wxStaticBox(panel, wxID_ANY, wxT("当前布局的窗体列表："));
	wxStaticBoxSizer* itemStaticBoxSizer5 = new wxStaticBoxSizer(itemStaticBoxSizer5Static, wxVERTICAL);
	panel->SetSizer(itemStaticBoxSizer5);

	m_tree = new wxTreeCtrl( panel, ID_LAYOUT_TREE, wxDefaultPosition, wxDefaultSize, wxTR_HAS_VARIABLE_ROW_HEIGHT | wxTR_HAS_BUTTONS );
	itemStaticBoxSizer5->Add(m_tree, 1, wxGROW|wxALL, 5);

	wxBoxSizer* itemBoxSizer7 = new wxBoxSizer(wxHORIZONTAL);
	itemStaticBoxSizer5->Add(itemBoxSizer7, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5);
	m_addWindow = new wxButton( panel, ID_ADD_WINDOW, wxT("新增窗体"), wxDefaultPosition, wxDefaultSize, 0 );//Add window
	itemBoxSizer7->Add(m_addWindow, 0, wxALIGN_TOP|wxALL, 5);
	m_saveSelection = new wxButton( panel, ID_SAVE_SELECTION, wxT("保存窗体"), wxDefaultPosition, wxDefaultSize, 0 );//Save current selection
	itemBoxSizer7->Add(m_saveSelection, 0, wxALIGN_TOP|wxALL, 5);

	wxStaticBox* itemStaticBoxSizer15Static = new wxStaticBox(panel, wxID_ANY, wxT("选中窗体的类型："));
	wxStaticBoxSizer* itemStaticBoxSizer15 = new wxStaticBoxSizer(itemStaticBoxSizer15Static, wxHORIZONTAL);
	itemStaticBoxSizer5->Add(itemStaticBoxSizer15, 0, wxGROW|wxALL, 5);
	m_typeText = new wxStaticText( panel, wxID_STATIC, wxT("静态文本"), wxDefaultPosition, wxDefaultSize, 0 );
	itemStaticBoxSizer15->Add(m_typeText, 1, wxGROW|wxALL, 5);

	wxStaticBox* itemStaticBoxSizer17Static = new wxStaticBox(panel, wxID_ANY, wxT("选中窗体的皮肤："));
	wxStaticBoxSizer* itemStaticBoxSizer17 = new wxStaticBoxSizer(itemStaticBoxSizer17Static, wxHORIZONTAL);
	itemStaticBoxSizer5->Add(itemStaticBoxSizer17, 0, wxGROW|wxALL, 5);
	wxArrayString itemComboBox18Strings;
	m_skinList = new wxComboBox( panel, ID_SKINS, wxEmptyString, wxDefaultPosition, wxDefaultSize, itemComboBox18Strings, wxCB_DROPDOWN );
	itemStaticBoxSizer17->Add(m_skinList, 1, wxGROW|wxALL, 5);

	wxArrayString itemRadioBox19Strings;
	itemRadioBox19Strings.Add(wxT("全部"));
	itemRadioBox19Strings.Add(wxT("共同部分"));
	m_displayModeRadio = new wxRadioBox( panel, ID_SKINS_DISPLAY, wxT("多选时皮肤和属性的显示模式："), wxDefaultPosition, wxDefaultSize, itemRadioBox19Strings, 1, wxRA_SPECIFY_ROWS );
	m_displayModeRadio->SetSelection(0);
	itemStaticBoxSizer5->Add(m_displayModeRadio, 0, wxGROW|wxALL, 5);


	//------------------------------ Panel1 -------------------------------
	wxPanel* panel1 = new wxPanel( splitter, ID_PANEL1, wxDefaultPosition, wxDefaultSize, wxNO_BORDER|wxTAB_TRAVERSAL );

	wxBoxSizer* itemBoxSizer11 = new wxBoxSizer(wxVERTICAL);
	panel1->SetSizer(itemBoxSizer11);

	wxStaticBox* itemStaticBoxSizer12Static = new wxStaticBox(panel1, wxID_ANY, wxT("选中窗体的文本："));
	...
	m_editText = new wxTextCtrl( panel1, ID_TEXT, wxEmptyString, wxDefaultPosition, wxSize(-1, 40), wxTE_MULTILINE | wxTE_RICH | wxTE_RICH2 );
	itemStaticBoxSizer12->Add(m_editText, 1, wxGROW|wxALL, 5);

	wxStaticBox* itemStaticBoxSizer22Static = new wxStaticBox(panel1, wxID_ANY, wxT("选中窗体的属性集："));
	wxStaticBoxSizer* itemStaticBoxSizer22 = new wxStaticBoxSizer(itemStaticBoxSizer22Static, wxHORIZONTAL);
	itemBoxSizer11->Add(itemStaticBoxSizer22, 1, wxGROW|wxALL, 5);

	wxSplitterWindow* itemSplitterWindow20 = new wxSplitterWindow( panel1, ID_SPLITTERWINDOW1, wxDefaultPosition, wxDefaultSize, wxSP_3DBORDER|wxSP_3DSASH|wxNO_BORDER );
	itemSplitterWindow20->SetMinimumPaneSize(40);

	m_grid = new wxGrid(itemSplitterWindow20, ID_GRID, wxDefaultPosition, wxDefaultSize, wxBORDER_THEME|wxHSCROLL|wxVSCROLL);
	m_grid->CreateGrid( 0, 2 );
	m_grid->SetColLabelValue(COLUMN_NAME, wxT("属性名"));
	m_grid->SetColLabelValue(COLUMN_VALUE, wxT("属性值"));
	UpdateColumnWidths();

	m_propertyDescText = new wxStaticText( itemSplitterWindow20, wxID_STATIC, wxT("属性说明"), wxDefaultPosition, wxSize(-1, 40), wxST_NO_AUTORESIZE|wxBORDER_THEME );

	itemSplitterWindow20->SplitHorizontally(m_propertyDescText, m_grid, 500);
	itemStaticBoxSizer22->Add(itemSplitterWindow20, 1, wxGROW|wxALL, 5);

	splitter->SplitVertically(panel, panel1, 200);
	itemBoxSizer2->Add(splitter, 1, wxGROW|wxALL, 5);
#else
	// All "groups"
...
void DialogMain::UpdateColumnWidths()
{
    if (m_propertySizer)
    {
        ...
        const int parentSize = m_propertySizer->GetSize().GetWidth();
        const int leftColSize = m_grid->GetColSize(COLUMN_NAME);
        // Reset the column widths
        m_grid->SetRowLabelSize(COLUMN_ROW_NUMBER_WIDTH);
        m_grid->SetColSize(COLUMN_VALUE, (parentSize-leftColSize)-(COLUMN_ROW_NUMBER_WIDTH-COLUMN_CUT_PADDING));
        m_grid->ForceRefresh();
    }
}
...
void DialogMain::AddPropertyRow(wxGridCellEditor* editor, const wxString& propertyName, const wxString& propertyValue, bool valueReadOnly /* = true */, const wxColour& textColor/* =*wxBLACK */, const wxColour& backgroundColor /* =*wxWHITE */, const wxColour& lockedBackgroundColor /* =*wxLIGHT_GREY */)
{
    ...
    wxString pname;
	PROPERTYDESCLIST &pds = Options::GetInstancePtr()->GetProperDescList();
	PROPERTYDESCLIST::iterator fitr = pds.find(propertyName);
	if(fitr != pds.end())
	{
		pname = fitr->second.Name;
	}
	else
	{
		pname = propertyName;
	}
	m_peNames.push_back(propertyName);

    // Make the index zero-based(!)
    m_grid->SetCellValue(newRowIndex, COLUMN_NAME, pname);
...
void DialogMain::ApplyFakePropertyChange()
{
    ...
    wxASSERT_MSG(m_currentWindow != NULL, wxT("Can't apply fake properties on empty window"));
    ...
    const CEGUI::String newName = StringHelper::ToCEGUIString(m_grid->GetCellValue(0, COLUMN_VALUE));
    if (newName != m_currentWindow->getName())
    {
        try
        {
            //WindowManager::getSingletonPtr()->renameWindow(m_currentWindow, newName);
            m_currentWindow->rename(newName);
            ...
            {
                m_tree->SetItemText(it->second, m_grid->GetCellValue(0, COLUMN_VALUE));
            }
        }
        // Add exception to log
    ...
    WindowBox* const box = m_document->GetSelection()->FindBoxFor(m_currentWindow);
    if (box)
    {
...
//------------------------------------------------------------------------
void DialogMain::OnSelchangedOverlayTree(wxTreeEvent& event) 
{
...
void DialogMain::SaveProperty(int row)
{
	...
	if (m_lastSelectedWindow != NULL && m_lastSelectedRow >= 0)
	{
		...
		else
		{
			...
			if(m_lastSelectedRow < m_peNames.size())
			{
				propertyName = m_peNames[m_lastSelectedRow];
			}
			else
			{
				propertyName = m_grid->GetCellValue(m_lastSelectedRow, COLUMN_NAME);
			}
...
void DialogMain::OnSelectCell( wxGridEvent& event )
{
	int row = event.GetRow();

	if(row < m_peNames.size())
	{
		wxString pdesc, pname = m_peNames[row];

		PROPERTYDESCLIST &pds = Options::GetInstancePtr()->GetProperDescList();

		PROPERTYDESCLIST::iterator fitr = pds.find(pname);

		if(fitr != pds.end())
		{
			pdesc = fitr->second.Desc;
		}
		else if(m_currentWindow->isPropertyPresent(StringHelper::ToCEGUIString(pname)))
		{
			pdesc = StringHelper::ToWXString(m_currentWindow->getPropertyHelp(StringHelper::ToCEGUIString(pname)));
		}
		else
		{
			pdesc = wxT("");
		...
		m_propertyDescText->SetLabel(pdesc);
	}
