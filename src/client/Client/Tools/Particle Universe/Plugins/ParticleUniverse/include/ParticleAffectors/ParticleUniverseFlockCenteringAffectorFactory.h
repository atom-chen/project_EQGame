    ...
    */
	class _ParticleUniverseExport FlockCenteringAffectorFactory : public ParticleAffectorFactory
	{
		public:
			...
			{
				// Delegate to mFlockCenteringAffectorTokens
				mFlockCenteringAffectorTokens.write(serializer, element);
			}

		protected:
			FlockCenteringAffectorTokens mFlockCenteringAffectorTokens;
