...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport DynamicAttributeFactory : public ITokenBind, public Ogre::FactoryAlloc
	{
	    public:
	        ...
	        */
			...
			{
				// Delegate to mDynamicAttributeTokens
				mDynamicAttributeTokens.write(serializer, element);
			}
