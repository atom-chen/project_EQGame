    ...
    */
	class _ParticleUniverseExport DoScaleEventHandlerFactory : public ParticleEventHandlerFactory
	{
		public:
			...
			{
				// Delegate to mDoScaleEventHandlerTokens
				mDoScaleEventHandlerTokens.setupTokenDefinitions(tokenRegister);
			}
			...
			{
				// Delegate to mDoScaleEventHandlerTokens
				mDoScaleEventHandlerTokens.write(serializer, element);
			}

		protected:
			DoScaleEventHandlerTokens mDoScaleEventHandlerTokens;
	};
