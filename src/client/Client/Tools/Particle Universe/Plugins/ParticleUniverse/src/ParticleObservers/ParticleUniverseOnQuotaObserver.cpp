...
{
	//-----------------------------------------------------------------------
	bool OnQuotaObserver::_observe (ParticleTechnique* particleTechnique, Particle* particle, Ogre::Real timeElapsed)
	{
		return mResult;
	}
	//-----------------------------------------------------------------------
	void OnQuotaObserver::_postProcessParticles(ParticleTechnique* particleTechnique, Ogre::Real timeElapsed)
	{
		mResult = false;
		size_t quota = 0;
