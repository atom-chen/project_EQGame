...
{
	// Constants
	const Ogre::uint32 OnEventFlagObserver::DEFAULT_EVENT_FLAG = 0;
	...
	//-----------------------------------------------------------------------
	bool OnEventFlagObserver::_observe (ParticleTechnique* particleTechnique, Particle* particle, Ogre::Real timeElapsed)
	{
		if (!particle)
			return false;
