...
namespace ParticleUniverse
{
	...
	//-----------------------------------------------------------------------
	void ColourAffector::addColour (Ogre::Real timeFraction, const Ogre::ColourValue& colour)
	{
	...
	//-----------------------------------------------------------------------
	void ColourAffector::_affect(ParticleTechnique* particleTechnique, Particle* particle, Ogre::Real timeElapsed)
	{
		...
		Ogre::Real timeFraction = (visualParticle->totalTimeToLive - visualParticle->timeToLive) / visualParticle->totalTimeToLive;
    ...
    //-----------------------------------------------------------------------
    ColourAffector::ColourMapIterator ColourAffector::_findNearestColourMapIterator(Ogre::Real timeFraction)
    {
