...
namespace ParticleUniverse
{
	...
	void ParticleAffector::copyParentAttributesTo(ParticleAffector* affector)
	{
		...
		affector->mExcludedEmitters = std::list<Ogre::String>(mExcludedEmitters); // Use copy constructor
	}
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	const std::list<Ogre::String>& ParticleAffector::getEmittersToExclude(void) const
	{
