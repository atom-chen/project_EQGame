...
namespace ParticleUniverse
{
	...
	DoEnableComponentEventHandler::DoEnableComponentEventHandler(void) : 
		...
		mComponentName(Ogre::StringUtil::BLANK),
		mComponentType(ParticleSystem::CT_EMITTER),
		mComponentEnabled(true)
	{
	}
	//-----------------------------------------------------------------------
	void DoEnableComponentEventHandler::_handle (ParticleTechnique* particleTechnique, Particle* particle, Ogre::Real timeElapsed)
	{
		...
		*/
		...
		{
			case ParticleSystem::CT_EMITTER:
			{
			...
			case ParticleSystem::CT_AFFECTOR:
			{
			...
			case ParticleSystem::CT_OBSERVER:
			{
			...
			case ParticleSystem::CT_TECHNIQUE:
			{
