...
{
	Ogre::Real Particle::DEFAULT_TTL = 10.0f;
	Ogre::Real Particle::DEFAULT_MASS = 1.0f;
	...
	//-----------------------------------------------------------------------
	ParticleBehaviour* Particle::getBehaviour(const Ogre::String& behaviourType)
	{
	...
	//-----------------------------------------------------------------------
	void Particle::copyBehaviours(std::vector<ParticleBehaviour*>& behaviours)
	{
		ParticleBehaviourIterator it;
	...
	//-----------------------------------------------------------------------
	Ogre::Real Particle::calculateVelocity(void) const
	{
	...
	//-----------------------------------------------------------------------
	void Particle::_process(ParticleTechnique* technique, Ogre::Real timeElapsed)
	{
	...
	//-----------------------------------------------------------------------
	void Particle::_initForExpiration(ParticleTechnique* technique, Ogre::Real timeElapsed)
	{
		if (mBehaviours.empty())
			return;
