...
//////////////////////////////////////////////////////////////////////////
void Selection::SaveMoveableBoxNRects()
{
	m_moveableBoxNRects.clear();

	for(Boxes::iterator boxItr = m_moveableBoxes.begin(); boxItr != m_moveableBoxes.end(); ++boxItr)
	{
		CEGUI::Window *win = boxItr->GetWindow();

		m_moveableBoxNRects.insert(NRects::value_type(win->getName(), win->getArea()));
	}
