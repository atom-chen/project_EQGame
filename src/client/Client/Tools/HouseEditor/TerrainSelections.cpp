...
Terrain* TerrainSelection::getTerrain(void) const
{
	return EQSceneManager::getSingleton().getTerrain();
}

TerrainData* TerrainSelection::getTerrainData(void) const
{
	return getTerrain()->getData(); 
}
...
{
    static const std::string type = "JunctionSelection";
    return type;
}
...
{
    static const std::string type = "GridSelection";
    return type;
}
