...
//-----------------------------------------------------------------------
static void eraseOperatorByGroupName(OperatorManager::OperatorList& operators, const std::string& groupName)
{
...
//-----------------------------------------------------------------------
OperatorManager::Group* OperatorManager::findGroup(const std::string& groupName)
{
...
//-----------------------------------------------------------------------
const OperatorManager::Group* OperatorManager::findGroup(const std::string& groupName) const
{
...
void OperatorManager::addOperator(Operator* op)
{
	...
	const std::string& groupName = op->getGroupName();
...
//-----------------------------------------------------------------------
size_t OperatorManager::undo(const std::string& groupName, size_t count)
{
	size_t n = 0;
...
//-----------------------------------------------------------------------
size_t OperatorManager::redo(const std::string& groupName, size_t count)
{
	size_t n = 0;
...
//-----------------------------------------------------------------------
const OperatorManager::OperatorList& OperatorManager::getUndoOperators(const std::string& groupName) const
{
...
//-----------------------------------------------------------------------
const OperatorManager::OperatorList& OperatorManager::getRedoOperators(const std::string& groupName) const
{
	const Group* group = findGroup(groupName);
	if (!group)
		return nullOperatorList;
