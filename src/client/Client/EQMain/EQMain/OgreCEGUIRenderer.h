...
\brief
	资源回收的监听
*/
class OgreCEGUIRecycleTextureListener
{
public:
	virtual ~OgreCEGUIRecycleTextureListener(){}
...
public:
	...
	*/
	...
	\brief
		启用资源回收机制
	*/
	void enableRecycleTexture(bool e);

	/*!
	\brief
		设置资源回收的时间间隔
	*/
	void setRecycleTextureInterval(long t) { d_recycleTextureInterval = t; }
	...
	*/
	...
	\brief
		设置资源回收监听
	*/
	void setRecycleTextureListener(OgreCEGUIRecycleTextureListener* l) {d_recycleTextureListener = l;}
...
private:
	...
	*************************************************************************/
	...
	bool						d_isEnableRecycleTexture;	//!< 是否启用的资源回收
	long						d_recycleTextureInterval;	//!< 资源回收的时间间隔
	OgreCEGUIRecycleTextureListener* d_recycleTextureListener;
};
