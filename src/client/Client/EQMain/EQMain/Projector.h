...
* 作者: Y3
* 时间: 2005-6-7
* 描述: 目前只提供对地形的投影, 对物件的投影需要碰撞系统的进一步支持. 来自TD.
******************************************************************************/
/********************************************************************
...
public:
	...
	*/
	virtual void setPatchMaterial(const std::string& materialName);

	/** Gets the name of the Material which the patch used with
	*/
	virtual const std::string& getPatchMaterialName(void) const;
