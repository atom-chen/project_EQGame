...
protected:
	...
	typedef std::map<std::string, ImageCache> ImageCacheMap;
	typedef std::vector<TextureCache> TextureCacheArray;
    ...
    AtlasArray mAtlases;
	ImageCacheMap mImageCaches;
	TextureCacheArray mTextureCaches;
...
public:
	...
	void padTex(ImageCache& ic, Ogre::Image& img);
	void TexBatch(ImageCache& ic, Ogre::Image& img, bool& imgLoaded);
