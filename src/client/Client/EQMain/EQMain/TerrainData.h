...
public:
    ...
    {
        std::string programNames[4];      // access by fog mode
    };
    ...
    typedef std::map<std::string, std::string> MaterialTemplates;
	...
	mutable GridInfoArrayCopys mGridInfoArrayCopys;

    std::string mName;                   //!< The name of the grid scene

    std::string mResourceGroupName;      //!< The resource group name contains terrain resources
    std::string mHeightmapType;          //!< The height-map file type
    std::string mHeightmapFilename;      //!< The height-map file name
	std::string mLightmapType;
	std::string mLightmapFilename;		//!< The light-map file name
    std::string mGridInfoFilename;       //!< The grid info file name    
...
public:
    ...
    int _registerPixmap(const std::string& textureName, Real left, Real top, Real right, Real bottom);
...
protected:
	void _loadBaseInfo(const std::string& filename, const std::string& groupName);
	void _saveBaseInfo(const std::string& filename) const;

	void _fixupMissingInfo(void);
    void _fixupSupportedMaterials(void);

	void _loadHeightmap(const std::string& filename, const std::string& type, const std::string& groupName);
    void _saveHeightmap(const std::string& filename) const;

	void _loadLightmap(const std::string& filename, const std::string& type, const std::string& groupName);
	void _saveLightmap(const std::string& filename) const;

    void _loadGridInfo(const std::string& filename, const std::string& groupName);
    void _saveGridInfo(const std::string& filename) const;

    bool _findGridInfoCopy(const std::string& fileName, size_t& index) const;
...
public:
    ...
    void reset(void);
    void load(const std::string& filename, const std::string& groupName, bool loadLightmap);
    void save(const std::string& filename, bool preservingNames = false) const;		
