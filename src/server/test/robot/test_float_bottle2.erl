...
%%
start() ->
    start(["127.0.0.1", "2222", "bottle_picker"]).
...
process_notify_enter_scene_result({notify_enter_scene_result, Result}, Socket, _List, State) ->
    case Result of
	    ...
	    timer:sleep(1000),
            ...
            send_data(Socket,  #req_pick_bottle{}),	    
            send_data(Socket,  #req_pick_bottle{}),	    
            send_data(Socket,  #req_pick_bottle{}),	    
	    ...
	    %%send_data(Socket, #req_del_bottle_log{is_pick_type=?TRUE, index=1}),
