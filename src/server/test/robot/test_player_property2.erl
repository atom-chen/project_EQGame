...
process_notify_be_invite({notify_invitation, Invitor, _InvitorName, ?ivt_trade}, Socket, _List, 
			 State) ->
    io:format(" 同意邀请\n"),  
    timer:sleep(100),
    send_data(Socket, #req_other_player_info{account=Invitor}),
    State.    
