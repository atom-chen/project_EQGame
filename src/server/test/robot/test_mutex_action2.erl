...
process_notify_be_invite({notify_invitation, Invitor, _InvitorName, ?ivt_trade=Type}, Socket, _List, 
			 State) ->
    io:format(" 同意邀请\n"),     
...
process_notify_player_leave_scene(#notify_player_leave_scene{account=SomeOne}, Socket, _List, 
			 State) ->
    io:format(" 请求对方交易\n"),
    Packet = #req_invite_someone{invitee=SomeOne, type=?ivt_trade},
