...
-record(npc_map_mapping_info, {id=0, npc_id=0, npc_name="", born_id=0, script_id=0, action=0, npc_key="", towards=0}).
...
-record(player_task_action, {type=0, finish_amount=0}).
-record(player_task, {id=0, account="", task_id=0, step_index=0, track=0, status=0, create_date=#stime{}, action_list=[]}).
...
-record(req_enter_common_scene, {scene_id=0, copy_id=0}).
-record(notify_enter_common_scene, {scene_id=0, born_id=0}).
-record(notify_enter_player_house, {account="", born_id=0, house_tplt_id=0}).
-record(req_teleport, {id=0, copy_id=0}).
...
-record(req_walk_for_body_action, {curr_pos=#point{}, dest_pos=#point{}, my_action="", you_action="", you_account="", you_pos=#point{}, move_type=0}).
...
-record(req_chat_big_expression, {exp_id=0}).
-record(notify_chat_big_expression, {account="", player_name="", exp_id=0}).
...
-record(notify_open_all_light, {turn_on=0}).
...
-record(notify_agree_invitation, {agreer="", type=0}).
...
-record(notify_update_task_progress, {id=0, action_type=0, action_amount=0}).
...
-record(notify_buy_new_house_success, {}).
...
-record(notify_today_flower_egg_count, {house_owner="", egg_count=0, flower_count=0}).
...
-record(req_common_scene_state, {teleport_id=0}).
-record(scene_state, {scene_id=0, copy_id=0, count=0, copy_name="", max_players=0, busy_players=0, loose_players=0, status=0}).
-record(notify_common_scene_state, {scene_list=[]}).
-record(req_cupid_participate, {account="", sex=0, tags=[]}).
-record(req_cupid_cancel_participate, {account=""}).
-record(notify_cupid_participate, {result=0}).
-record(notify_cupid_cancel_participate, {result=0}).
-record(notify_cupid_girl_match_result, {tags=[]}).
-record(notify_cupid_boy_match_result, {tags=[], girl_result=0}).
-record(req_cupid_girl_confirm, {account="", result=0}).
-record(req_cupid_boy_confirm, {account="", result=0, girl_result=0}).
-record(req_create_party, {type=0, title="", description=""}).
-record(notify_create_party_result, {result=0}).
-record(req_edit_party, {type=0, title="", description=""}).
-record(notify_edit_party_result, {result=0}).
-record(req_delete_party, {}).
-record(req_get_party_list, {}).
-record(party_data, {create_account="", type=0, title="", desc=""}).
-record(notify_party_list, {partys=[]}).
...
-define(msg_player_task_action, 19).
-define(msg_player_task, 20).
-define(msg_eq_user_info, 21).
-define(msg_offline_invite_record, 22).
-define(msg_friend_setting_record, 23).
-define(msg_magic_box, 24).
-define(msg_gift_box, 25).
-define(msg_flower_log, 26).
-define(msg_egg_log, 27).
-define(msg_req_login, 28).
-define(msg_notify_login_result, 29).
-define(msg_notify_repeat_login, 30).
-define(msg_req_get_roles, 31).
-define(msg_notify_get_roles_result, 32).
-define(msg_req_create_role, 33).
-define(msg_notify_create_role_result, 34).
-define(msg_req_enter_scene, 35).
-define(msg_notify_enter_scene_result, 36).
-define(msg_notify_body_data, 37).
-define(msg_req_enter_player_house, 38).
-define(msg_req_enter_common_scene, 39).
-define(msg_notify_enter_common_scene, 40).
-define(msg_notify_enter_player_house, 41).
-define(msg_req_teleport, 42).
-define(msg_req_open_change_scene_guide, 43).
-define(msg_notify_open_change_scene_guide, 44).
-define(msg_req_close_change_scene_guide, 45).
-define(msg_notify_close_change_scene_guide, 46).
-define(msg_notify_finish_enter_scene, 47).
-define(msg_req_kick_guest, 48).
-define(msg_notify_other_player_data, 49).
-define(msg_notify_other_player_info, 50).
-define(msg_req_other_player_info, 51).
-define(msg_notify_player_enter_scene, 52).
-define(msg_notify_player_leave_scene, 53).
-define(msg_req_logout, 54).
-define(msg_notify_player_data, 55).
-define(msg_req_walk, 56).
-define(msg_req_start_walk, 57).
-define(msg_notify_start_walk, 58).
-define(msg_req_stop_walk, 59).
-define(msg_notify_stop_walk, 60).
-define(msg_req_sync_position, 61).
-define(msg_req_walk_for_use_furniture, 62).
-define(msg_req_walk_for_body_action, 63).
-define(msg_req_add_friend, 64).
-define(msg_req_remove_friend, 65).
-define(msg_notify_add_friend, 66).
-define(msg_notify_remove_friend, 67).
-define(msg_req_friend_list, 68).
-define(msg_notify_friend_list, 69).
-define(msg_notify_friend_online, 70).
-define(msg_notify_friend_offline, 71).
-define(msg_req_eq_users_info, 72).
-define(msg_notify_eq_user_info, 73).
-define(msg_notify_eq_user_presence, 74).
-define(msg_notify_offline_invites, 75).
-define(msg_req_friend_setting, 76).
-define(msg_notify_friend_setting, 77).
-define(msg_req_friend_setting_accept_all, 78).
-define(msg_req_friend_setting_black_someone, 79).
-define(msg_req_search_player_by_nick, 80).
-define(msg_req_search_player_by_mail, 81).
-define(msg_notify_search_player, 82).
-define(msg_req_chat_around, 83).
-define(msg_notify_chat_around, 84).
-define(msg_req_chat_tell, 85).
-define(msg_notify_chat_tell, 86).
-define(msg_req_chat_big_expression, 87).
-define(msg_notify_chat_big_expression, 88).
-define(msg_house_furniture, 89).
-define(msg_room_tex, 90).
-define(msg_house_component_tex, 91).
-define(msg_house_component_mesh, 92).
-define(msg_house_visit_log, 93).
-define(msg_house_data, 94).
-define(msg_notify_house_clean, 95).
-define(msg_notify_house_data, 96).
-define(msg_notify_house_gift_box, 97).
-define(msg_req_placed_furniture, 98).
-define(msg_req_start_edit_house, 99).
-define(msg_notify_start_edit_house, 100).
-define(msg_req_end_edit_house, 101).
-define(msg_notify_end_edit_house, 102).
-define(msg_req_recovery_furniture, 103).
-define(msg_req_replace_component_mesh, 104).
-define(msg_req_replace_component_tex, 105).
-define(msg_req_replace_room_tex, 106).
-define(msg_notify_replace_room_tex, 107).
-define(msg_req_move_furniture, 108).
-define(msg_notify_add_furniture, 109).
-define(msg_notify_delete_furniture, 110).
-define(msg_req_house_basic_data, 111).
-define(msg_notify_house_basic_data, 112).
-define(msg_req_set_house_welcome_words, 113).
-define(msg_notify_set_house_welcome_words, 114).
-define(msg_req_set_house_permission, 115).
-define(msg_notify_set_house_permission, 116).
-define(msg_req_clear_house_log, 117).
-define(msg_notify_clear_house_log, 118).
-define(msg_req_change_house, 119).
-define(msg_notify_change_house, 120).
-define(msg_req_house_list, 121).
-define(msg_house_plot_info, 122).
-define(msg_notify_house_list, 123).
-define(msg_notify_player_property_changed, 124).
-define(msg_control_furni_info, 125).
-define(msg_mutli_furni_info, 126).
-define(msg_req_use_mutli_furni, 127).
-define(msg_notify_use_mutli_furni, 128).
-define(msg_notify_use_furniture_result, 129).
-define(msg_req_stop_using_furniture, 130).
-define(msg_notify_stop_using_furniture_result, 131).
-define(msg_notify_open_all_light, 132).
-define(msg_notify_package, 133).
-define(msg_req_swap_item, 134).
-define(msg_req_use_item, 135).
-define(msg_req_move_item, 136).
-define(msg_req_delete_item, 137).
-define(msg_req_split_item, 138).
-define(msg_req_resize_player_pack, 139).
-define(msg_req_lock_bag_item, 140).
-define(msg_req_unlock_bag_item, 141).
-define(msg_req_move_money, 142).
-define(msg_req_switch_item, 143).
-define(msg_notify_sys_msg, 144).
-define(msg_notify_sys_broadcast, 145).
-define(msg_req_fixed_broadcast, 146).
-define(msg_notify_del_broadcast, 147).
-define(msg_req_gm_command, 148).
-define(msg_notify_npc_list, 149).
-define(msg_notify_npc_close_dialog, 150).
-define(msg_notify_npc_show_dialog_by_option, 151).
-define(msg_notify_npc_show_dialog_by_message, 152).
-define(msg_notify_npc_show_dialog_by_item, 153).
-define(msg_req_npc_command, 154).
-define(msg_req_player_basic_data, 155).
-define(msg_notify_player_basic_data, 156).
-define(msg_req_start_body_action, 157).
-define(msg_notify_start_body_action, 158).
-define(msg_req_play_animation, 159).
-define(msg_notify_play_animation, 160).
-define(msg_req_end_body_action, 161).
-define(msg_notify_end_body_action, 162).
-define(msg_req_sync_body_state, 163).
-define(msg_notify_other_body_state, 164).
-define(msg_req_start_change_looks, 165).
-define(msg_notify_start_change_looks, 166).
-define(msg_req_cancel_change_looks, 167).
-define(msg_req_end_change_looks, 168).
-define(msg_notify_change_looks, 169).
-define(msg_notify_end_change_looks, 170).
-define(msg_notify_around_change_dress, 171).
-define(msg_req_invite_someone, 172).
-define(msg_notify_invitation, 173).
-define(msg_req_agree_invitation, 174).
-define(msg_notify_agree_invitation, 175).
-define(msg_req_disagree_invitation, 176).
-define(msg_notify_cancel_invitation, 177).
-define(msg_notify_start_trade, 178).
-define(msg_req_update_trade_money, 179).
-define(msg_notify_update_trade_money, 180).
-define(msg_notify_other_update_trade_money, 181).
-define(msg_req_put_trade_item, 182).
-define(msg_notify_put_trade_item, 183).
-define(msg_notify_other_put_trade_item, 184).
-define(msg_req_unput_trade_item, 185).
-define(msg_notify_unput_trade_item, 186).
-define(msg_notify_other_unput_trade_item, 187).
-define(msg_req_swap_trade_item, 188).
-define(msg_notify_swap_trade_item, 189).
-define(msg_notify_other_swap_trade_item, 190).
-define(msg_req_sure_trade, 191).
-define(msg_notify_sure_trade, 192).
-define(msg_notify_other_sure_trade, 193).
-define(msg_req_cancel_trade, 194).
-define(msg_notify_cancel_trade, 195).
-define(msg_notify_trade_success, 196).
-define(msg_furniture_goods_data, 197).
-define(msg_req_buy_sys_shop_goods, 198).
-define(msg_req_buy_sys_shop_goods_list, 199).
-define(msg_notify_buy_furniture_list, 200).
-define(msg_player_coin, 201).
-define(msg_notify_update_coin, 202).
-define(msg_req_buy_npc_shop_goods, 203).
-define(msg_req_sell_goods, 204).
-define(msg_notify_open_shop, 205).
-define(msg_farm_pet_food, 206).
-define(msg_farm_log_message, 207).
-define(msg_farm_log_gain, 208).
-define(msg_farm_log_consumption, 209).
-define(msg_farm_comment, 210).
-define(msg_farm_decoration, 211).
-define(msg_farm_crop_data, 212).
-define(msg_player_farm_data, 213).
-define(msg_farm_exp_data, 214).
-define(msg_farm_hint_data, 215).
-define(msg_farm_pick_all_result, 216).
-define(msg_player_farm_log, 217).
-define(msg_player_farm_comment, 218).
-define(msg_farm_status, 219).
-define(msg_req_enter_farm, 220).
-define(msg_notify_farm_data, 221).
-define(msg_req_leave_farm, 222).
-define(msg_notify_leave_farm, 223).
-define(msg_req_assart_plot, 224).
-define(msg_req_sow, 225).
-define(msg_req_pick_crop, 226).
-define(msg_req_pick_all_crops, 227).
-define(msg_req_get_friend_farm_state, 228).
-define(msg_notify_friend_farm_status, 229).
-define(msg_req_weed, 230).
-define(msg_req_worm, 231).
-define(msg_req_water, 232).
-define(msg_notify_pet_bite, 233).
-define(msg_req_farm_log_list, 234).
-define(msg_notify_farm_log_list, 235).
-define(msg_req_clear_farm_log, 236).
-define(msg_req_buy_farm_shop_goods, 237).
-define(msg_req_sell_farm_shop_goods, 238).
-define(msg_req_sell_farm_shop_all_goods, 239).
-define(msg_notify_farm_info, 240).
-define(msg_req_farm_comment, 241).
-define(msg_notify_farm_comment, 242).
-define(msg_req_reply_farm_comment, 243).
-define(msg_notify_reply_farm_comment, 244).
-define(msg_req_farm_comment_list, 245).
-define(msg_notify_farm_comment_list, 246).
-define(msg_req_clear_farm_comment, 247).
-define(msg_notify_clear_farm_comment, 248).
-define(msg_req_remove_decoration, 249).
-define(msg_req_change_decoration, 250).
-define(msg_req_put_grass, 251).
-define(msg_req_put_pest, 252).
-define(msg_farm_setting, 253).
-define(msg_req_farm_setting, 254).
-define(msg_req_set_farm_setting, 255).
-define(msg_notify_set_farm_setting, 256).
-define(msg_req_reset_farm_setting, 257).
-define(msg_notify_reset_farm_setting, 258).
-define(msg_notify_farm_setting, 259).
-define(msg_req_lock_depot_item, 260).
-define(msg_req_unlock_depot_item, 261).
-define(msg_req_hoeing, 262).
-define(msg_req_use_farm_item, 263).
-define(msg_req_can_assart_plot, 264).
-define(msg_req_can_upgrade_land, 265).
-define(msg_req_upgrade_land, 266).
-define(msg_notify_farm_money, 267).
-define(msg_notify_farm_awards, 268).
-define(msg_notify_farm_eq_coin, 269).
-define(msg_req_task_list, 270).
-define(msg_notify_task_list, 271).
-define(msg_req_farm_task_list, 272).
-define(msg_notify_farm_task_list, 273).
-define(msg_req_track_task, 274).
-define(msg_notify_track_task, 275).
-define(msg_req_get_track_list, 276).
-define(msg_notify_get_track_list, 277).
-define(msg_req_cancel_track_task, 278).
-define(msg_notify_cancel_track_task, 279).
-define(msg_req_give_up_task, 280).
-define(msg_notify_give_up_task, 281).
-define(msg_notify_update_task_progress, 282).
-define(msg_notify_task_complete, 283).
-define(msg_notify_give_task, 284).
-define(msg_req_complete_task, 285).
-define(msg_notify_give_farm_task, 286).
-define(msg_req_farm_complete_task, 287).
-define(msg_notify_farm_task_complete, 288).
-define(msg_notify_mail_not_read, 289).
-define(msg_notify_add_mail, 290).
-define(msg_req_delete_mail, 291).
-define(msg_notify_delete_mail, 292).
-define(msg_req_get_mail_item, 293).
-define(msg_notify_delete_mail_item, 294).
-define(msg_req_mail_list, 295).
-define(msg_notify_mail_list, 296).
-define(msg_req_mail_content, 297).
-define(msg_notify_mail_content, 298).
-define(msg_req_know_new_mail_title, 299).
-define(msg_req_reject_mail, 300).
-define(msg_req_send_mail, 301).
-define(msg_notify_send_mail_success, 302).
-define(msg_notify_reject_mail_success, 303).
-define(msg_req_open_ui, 304).
-define(msg_notify_open_ui, 305).
-define(msg_req_sys_time, 306).
-define(msg_notify_day_or_night, 307).
-define(msg_notify_sys_time, 308).
-define(msg_notify_wallow_time, 309).
-define(msg_notify_player_health_status, 310).
-define(msg_notify_disease_special_event, 311).
-define(msg_req_start_buy_house, 312).
-define(msg_notify_start_buy_house, 313).
-define(msg_req_end_buy_house, 314).
-define(msg_notify_end_buy_house, 315).
-define(msg_req_buy_house, 316).
-define(msg_notify_buy_house, 317).
-define(msg_req_buy_house_replace, 318).
-define(msg_req_buy_house_add, 319).
-define(msg_notify_buy_new_house_success, 320).
-define(msg_req_deposit_money_in_depot, 321).
-define(msg_req_withdraw_money_in_depot, 322).
-define(msg_notify_player_depot, 323).
-define(msg_req_start_domestic, 324).
-define(msg_notify_start_domestic, 325).
-define(msg_req_domestic_service, 326).
-define(msg_notify_domestic_result, 327).
-define(msg_req_end_domestic, 328).
-define(msg_notify_end_domestic, 329).
-define(msg_req_walk_for_pick_magic_box, 330).
-define(msg_req_pick_magic_box, 331).
-define(msg_req_client_empty_box_positions, 332).
-define(msg_notify_server_empty_box_positions, 333).
-define(msg_notify_house_magic_box, 334).
-define(msg_notify_del_house_magic_box, 335).
-define(msg_notify_add_house_magic_box, 336).
-define(msg_notify_pick_magic_box_gain, 337).
-define(msg_notify_friend_garbage, 338).
-define(msg_req_start_gift_service, 339).
-define(msg_notify_start_gift_service, 340).
-define(msg_req_end_gift_service, 341).
-define(msg_notify_end_gift_service, 342).
-define(msg_req_pack_gift_box, 343).
-define(msg_notify_pack_gift_box, 344).
-define(msg_req_unpack_gift_box, 345).
-define(msg_notify_unpack_gift_box, 346).
-define(msg_req_put_gift_box, 347).
-define(msg_notify_put_gift_box, 348).
-define(msg_req_pickup_gift_box, 349).
-define(msg_notify_pickup_gift_box, 350).
-define(msg_notify_gift_box, 351).
-define(msg_req_get_send_box_vec, 352).
-define(msg_notify_get_send_box_vec, 353).
-define(msg_req_get_receive_box_vec, 354).
-define(msg_notify_get_receive_box_vec, 355).
-define(msg_req_get_viewed_box_vec, 356).
-define(msg_notify_get_viewed_box_vec, 357).
-define(msg_gift_express, 358).
-define(msg_req_send_gift_express, 359).
-define(msg_notify_send_gift_express, 360).
-define(msg_req_receive_gift_express, 361).
-define(msg_notify_receive_gift_express, 362).
-define(msg_req_get_send_express_vec, 363).
-define(msg_notify_get_send_express_vec, 364).
-define(msg_req_get_receive_express_vec, 365).
-define(msg_notify_express_vec, 366).
-define(msg_notify_send_express, 367).
-define(msg_req_send_express_by_subscribe, 368).
-define(msg_notify_get_receive_express_vec, 369).
-define(msg_req_get_viewed_express_vec, 370).
-define(msg_notify_get_viewed_express_vec, 371).
-define(msg_req_clean_gift_log, 372).
-define(msg_notify_show_picture, 373).
-define(msg_req_start_work, 374).
-define(msg_notify_start_work, 375).
-define(msg_req_work, 376).
-define(msg_notify_work_result, 377).
-define(msg_req_end_work, 378).
-define(msg_notify_end_work, 379).
-define(msg_req_get_weibo_access_secret, 380).
-define(msg_notify_weibo_access_secret, 381).
-define(msg_req_save_access_secret, 382).
-define(msg_req_preview_house, 383).
-define(msg_notify_preview_house, 384).
-define(msg_req_preview_shop_house, 385).
-define(msg_req_end_preview_house, 386).
-define(msg_notify_end_preview_house, 387).
-define(msg_bottle_info, 388).
-define(msg_req_del_bottle_log, 389).
-define(msg_req_drop_bottle, 390).
-define(msg_notify_drop_bottle, 391).
-define(msg_req_pick_bottle, 392).
-define(msg_notify_pick_bottle, 393).
-define(msg_req_all_bottle_info, 394).
-define(msg_notify_bottles_info, 395).
-define(msg_notify_today_bottle_info, 396).
-define(msg_notify_open_float_bottle_pool, 397).
-define(msg_notify_house_decoration, 398).
-define(msg_notify_new_day_reset, 399).
-define(msg_notify_total_flower_count, 400).
-define(msg_req_send_flower, 401).
-define(msg_notify_send_flower_success, 402).
-define(msg_req_flower_logs, 403).
-define(msg_notify_flower_logs, 404).
-define(msg_notify_house_flower_change, 405).
-define(msg_req_send_egg, 406).
-define(msg_notify_send_egg_success, 407).
-define(msg_req_egg_logs, 408).
-define(msg_notify_egg_logs, 409).
-define(msg_notify_today_flower_egg_count, 410).
-define(msg_notify_house_egg_change, 411).
-define(msg_req_is_active_game, 412).
-define(msg_notify_active_game_result, 413).
-define(msg_req_common_scene_state, 414).
-define(msg_scene_state, 415).
-define(msg_notify_common_scene_state, 416).
-define(msg_req_cupid_participate, 417).
-define(msg_req_cupid_cancel_participate, 418).
-define(msg_notify_cupid_participate, 419).
-define(msg_notify_cupid_cancel_participate, 420).
-define(msg_notify_cupid_girl_match_result, 421).
-define(msg_notify_cupid_boy_match_result, 422).
-define(msg_req_cupid_girl_confirm, 423).
-define(msg_req_cupid_boy_confirm, 424).
-define(msg_req_create_party, 425).
-define(msg_notify_create_party_result, 426).
-define(msg_req_edit_party, 427).
-define(msg_notify_edit_party_result, 428).
-define(msg_req_delete_party, 429).
-define(msg_req_get_party_list, 430).
-define(msg_party_data, 431).
-define(msg_notify_party_list, 432).

-define(proto_ver, 290).
