...
g_rttBeautyWinName = "BeautyRttWindow"	-- 美容院(hezhr)
...
--礼物系统
g_giftSystem = EQGlobaClass.getGiftSystem()
...
--
g_ItemInteractMgr = EQGlobaClass.getItemInteractSys()
--
g_OfflineMsgMgr = EQGlobaClass.getOfflineMsgMgr()

g_IITConn = EQGlobaClass.getIITConn()

g_GameStateMgr = EQGlobaClass.getGameStateMgr()

--漂流瓶
g_DriftBottleSys = EQGlobaClass.getDriftBottleSys()
...
g_PlayerSearch = EQGlobaClass.getPlayerSearch()
--
----农场表格管理器
...
--邀请协议
g_req_agree_invitation = EQGlobaClass.req_agree_invitation()
g_req_disagree_invitation = EQGlobaClass.req_disagree_invitation()
g_req_friend_setting_black_someone =  EQGlobaClass.req_friend_setting_black_someone()

--
g_req_other_player_info = EQGlobaClass.req_other_player_info()
--
g_loadedmesh = false
...
g_PT_IITSLOTS	= EQGlobaClass.ItemPack.PT_IITSLOTS
g_PT_FARMDEPOT  = EQGlobaClass.ItemPack.PT_FARMDEPOT
...
g_CS_CHANGE_FLOOR	= EQGlobaClass.CursorMgr.CS_CHANGE_FLOOR
g_CS_CHANGE_WALL = EQGlobaClass.CursorMgr.CS_CHANGE_WALL
...
g_itemMgr = EQGlobaClass.getItemMgr()